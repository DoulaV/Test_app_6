...
Good branding is an intentional pairing of relevant things done consistently.
...
2. What do I have to be known for in order for that to happen?
3. What do I have to do in order to be known for that?
...
Three sources of a fresh perspective:
1. The information you have.
2. Your philosophy on the subject.
3. Your personality and unique take.
...
1. Catalyst: why your brand exists, because something needed to change.
   What needs to change? What do you see that others don't? Why do you feel the need to act on it?
2. Core Truth: what makes you different, because blending in leads to being forgotten.
   What makes you different? What does your audience already praise you for? Why would they care and what value does it bring them?
3. Proof: how you reinforce that identity every single day, in what you say and in what you do.
...
Don't cater what you're saying just to the audience. Nobody likes that. That's what we call a politician.
...
This skill: spend 20% on genuine other interests.
Both are right about different systems. Distribution punishes drift; relationships need more than one thing in common.
So: off-band content is not free and it is not forbidden, it is priced. It costs reach on the following posts and buys depth of attachment.
Spend it deliberately, when there is reach to spare, on things genuinely yours, connected back to the core where honest.
No established fit score: near 0%. Reliable band with a loyalty problem: the full 20%.
```
